...
export default function DynamicHeroCarousel() {
  ...
  const t = useT()
                const merchantTypes = [
    {
      ...
      emoji: '🥬',
      title: t(
        'Shop from local groceries, restaurants, and pharmacies in you area. Get your items delivered to you instantly.',
      ),
      subtitle: '',
      description: t(
        'Farm-fresh produce, pantry essentials, and daily necessities delivered in minutes.',
      ),
    ...
    },
    {
      ...
      description: t(
        'Your favorite restaurants and local eateries, delivering happiness one meal at a time.',
      ),
      imageOverlayText: t(
        'Delicious Meals from Restaurants near you are ready to be delivered to you',
      ),
    ...
    },
    {
      ...
      description: t(
        'Prescription medications, health products, and wellness items delivered with care.',
      ),
      imageOverlayText: t(
        'Shop Prescription Medications and health products, without leaving your home.',
      ),
                  ...
                  {merchantTypes.map((_, index) => (
                    <motion.button
                      ...
                      className={`h-1.5 rounded-full transition-all duration-300 ${
                        index === currentIndex ? 'w-12 bg-gray-800' : 'w-8 bg-gray-400'
                      }`}
