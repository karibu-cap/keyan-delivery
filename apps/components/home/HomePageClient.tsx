                    ...
                    <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                        ...
                        <Card className="p-8 rounded-2xl shadow-card hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1">
                            <div className="flex flex-col items-center text-center">
                                ...
                                >
                                    {isDriver ? t("Go to driver dashboard") : t("Apply as Driver")}
                                </Button>
                            </div>
                        </Card>
                    </div>
            ...
            <section className="relative gradient-hero h-80 max-md:h-100">
                <div className="h-full w-full relative overflow-hidden">
                    ...
                    <div className="text-white text-center absolute z-10 h-full w-full justify-items-center">
                        <div className="justify-items-center justify-center flex flex-col w-full h-full">
            ...
            < footer className="bg-card border-t border-border py-12 px-4" >
                <div className="container mx-auto max-w-7xl">
                    <div className="grid md:grid-cols-4 gap-8 mb-8">
                        <div>
                            <div className="flex items-center space-x-2 mb-4">
                                ...
                                <span className="text-xl font-bold text-primary">Pataupesi</span>
                            </div>
                    ...
                    <div className="pt-8 border-t border-border text-center text-sm text-muted-foreground">
                        <p>&copy; 2025 Pataupesi. {t("All rights reserved.")}</p>
                    </div>
                </div>
            </footer >
        </>
