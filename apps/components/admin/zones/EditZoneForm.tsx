...
import { ZoneCode, ZoneStatus, type DeliveryZone, type Landmark } from '@prisma/client';
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                    <h1 className="text-3xl font-bold text-foreground">{t('Edit Delivery Zone')}</h1>
                    <p className="text-muted-foreground mt-1">
                        {t('Update zone boundaries, pricing, and landmarks')}
                    </p>
                </div>
                <div className="text-sm text-muted-foreground">
                    {t('Version')}: {zone.version}
                </div>
            </div>
